...
const SaveForLater = () => {
  ...
  const sortedSaveForLater = [...saveForLater].sort((a, b) => {
    if (sortBy === "Duration") {
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-[#181b22] border border-gray-800/60 
  px-3 py-1.5 pr-8 rounded-lg text-white text-xs"
            >
